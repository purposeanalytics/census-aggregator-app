...
#   level: "csd"
params:
  geo_uid: !r c("4704045", "4704019", "4704050", "4704024", "4704011", "4704003", "4704006", "4704034", "4704058", "4704054", "4704038")
  # geo_uid: !r c("3520005")
  level: "csd"
...
ggplot() +
  geom_sf(data = boundaries_data, colour = "grey", fill = NA) +
...
data_export <- bind_rows(
  tribble(
    ...
    "Population change (2016 to 2021)", population_change,
  ...
  # Age (5 year buckets)
  # TODO - ordering
  data_export %>% filter(label_short == "age"),
  # Age (cohorts)
  data_export %>% filter(label_short == "age_cohorts"),
