...
source(here::here("R", "utils_report_helpers.R"))
...
if(geography =='region'){
 boundaries_data <- st_make_valid(boundaries_data) 
}
...
ggplot() +
  ...
  theme_void() +
  annotation_scale(location = "br", line_width = 0.5, height = unit(0.15, "cm"),
                   pad_x = unit(0.75, "cm"), pad_y = unit(0.75, "cm"), text_cex = 0.5)

# if(nrow(region_boundaries) < 10) {
#   
#   p + geom_text(region_boundaries$geoname)
# }
